...
private:
	...
	TArray<FAsyncTaskDebugMessages> calculateColorsResultMessage;
	...
	float paintAtLocation_FallOffRange_Global = 0;
	float paintAtLocation_DistianceFromFalloffBase_Global = 0;
	float paintAtLocation_ScaleFalloffFrom_Global = 0;
