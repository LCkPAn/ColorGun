...
public:
	...
	static void PrintTaskLog(FVertexDetectFundementalStruct fundementalStruct, const FString text, FColor screenTextColor = FColor::Cyan);
	...
	static FVertexDetectRGBAStruct ClampPaintStrengths(FVertexDetectRGBAStruct applyVertexColorSettings);
	...
	static FVertexDetectRGBAStruct ClampPaintLimits(FVertexDetectRGBAStruct applyColorSetting);
...
private:
	...
	static bool CheckValidFundementals(FVertexDetectFundementalStruct taskFundementals, UPrimitiveComponent* component);

	static bool CheckValidVertexPaintSettings(FVertexPaintStruct vertexPaintSettings);

	static bool CheckValidVertexPaintColorSettings(FVertexPaintColorSettingStruct colorSettings);

	static bool CheckHaveReachedMaxDetectionTask(FVertexDetectFundementalStruct fundementalSettings);
};
